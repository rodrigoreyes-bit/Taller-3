...
/**
 * Clase principal que contiene el punto de entrada de la aplicación y maneja la
 * interacción del usuario a través de menús. Implementa el patrón Singleton
...
public class App {
	...
	/**
	 * Punto de entrada principal de la aplicación. Carga los datos iniciales y
	 * luego inicia el proceso de Login.
	 * 
	...
	/**
	 * Maneja el proceso de inicio de sesión del usuario. Solicita nombre de usuario
	 * y contraseña hasta que el login sea exitoso o el usuario escriba 'exit'.
	...
	/**
	 * Lee las tareas desde el archivo "tareas.txt" y las carga en el sistema. Se
	 * espera que el archivo use '|' como separador de campos.
	 * 
	...
	/**
	 * Muestra y maneja el menú de opciones para el usuario con rol de
	 * Administrador.
	 */
	private static void menuAdmin() {
		// En caso que el usuario ingresado tenga el rol Admin se abre este menú de
		// opciones.
	...
	private static void menuUsuario() {
		// En caso que el usuario ingresado tenga el rol User se abre este menu de
		// opciones.
		scan = new Scanner(System.in);
		int opcion = -1;
		do {
